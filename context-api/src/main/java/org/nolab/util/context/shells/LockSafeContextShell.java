...
public class LockSafeContextShell implements LockSafeContext, Serializable {
    ...
    private static final long serialVersionUID = 1367436378069189755L;
     ...
     * @throws NullPointerException if {@code encapsulated} is null
     */
    public LockSafeContextShell(Context encapsulated, boolean copyInShell) {
        this.encapsulated = Objects.requireNonNull(encapsulated);
    ...
    @Override
    public LockSafeContext copy() {
        return copyInShell
                ? new LockSafeContextShell(encapsulated.copy())
